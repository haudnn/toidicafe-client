...
import { selectIsSearch, selectPlace, selectReviews, writeActions } from '../writeSlice';
...
const Write = () => {
  ...
  useOnClickOutside(ref, () => dispatch(writeActions.hideSearch()));
  const handleShowSearch = () => {
    dispatch(writeActions.showSearch());
  };
  const handleClose = () => {
    dispatch(writeActions.unPickedPlace())
  }
  return (
                        ...
                        <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center ">
                          ...
                          >
                            <div className="h-[50px] px-10 w-full shrink-0 text-center border-b border-solid border-[rgba(0,0,0,0.1)]">
                              ...
                              <div
                                onClick={() => dispatch(writeActions.hideSearch())}
