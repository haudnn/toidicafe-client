...
import { reviewActions, selectMessage, selectPlace } from '../../review/reviewSlice';
...
const ReviewForm = ({id} :any) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    images.forEach((image:any) =>  formData.append('image', image.file));
    for (let key of Object.keys(star)) {
      formData.append(`star[${key}]`, `${star[key as keyof Star]}`);
    }
